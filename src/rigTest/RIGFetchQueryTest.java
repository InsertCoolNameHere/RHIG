...
public class RIGFetchQueryTest {
	...
	private static Query buildQuery() {
		...
		q.addOperation(new Operation(new Expression("==", new Feature(utility.Math.TEMPORAL_YEAR_FEATURE, 2018)),new Expression("==", new Feature(utility.Math.TEMPORAL_MONTH_FEATURE, 9))));
		return q;
	}
